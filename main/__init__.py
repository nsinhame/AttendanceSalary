...
app.config["SECRET_KEY"] = "5791628bb0b13ce0c666dfde280ba245"                    # Set the secret key
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///site.db"                      # Initialize the database
app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False                             # Set it False for production environment
