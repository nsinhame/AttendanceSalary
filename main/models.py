...
class WorkerDetail(db.Model):
    ...
    worker_id = db.Column(db.String(6), db.ForeignKey("WorkerPrimary.worker_id"), primary_key = True, nullable = False, unique=True)  # Worker ID is a foreign key from Worker Primary table
    ...
    project_id = db.Column(db.String(6), db.ForeignKey("ProjectData.project_id"), nullable = False, unique = False) # Site ID where the worker is working
...
class WorkerAttendance(db.Model):
    ...
    row_id = db.Column(db.String(6), primary_key = True, nullable = False, unique=True)                    # Row ID works as a primary key as Worker ID is repeated after every day and hence can be used as a primary key.
...
class SiteData(db.Model):
    ...
    site_name = db.Column(db.String(30), nullable = False, unique = False)                     # Name of the site
    location_id = db.Column(db.String(6), db.ForeignKey("LocationData.location_id"), nullable = False, unique = False) # Location ID being used as a foreign key
...
class ProjectData(db.Model):
    ...
    site_id = db.Column(db.String(6), db.ForeignKey("SiteData.site_id"), nullable = False, unique = False) # ID of the site is used as foreign key
    location_id = db.Column(db.String(6), db.ForeignKey("LocationData.location_id"), nullable = False, unique = False) # ID of the location being used as foreign key
...
class SiteEngineerDetails(db.Model):
    ...
    location_id = db.Column(db.String(6), db.ForeignKey("LocationData.location_id"), nullable = False, unique = False) # ID of the location where the Site Engineer is working used as a foreign key
    site_id = db.Column(db.String(6), db.ForeignKey("SiteData.site_id"), nullable = False, unique = False) # ID of the site being used as a foreign key
...
class SupervisorDetails(db.Model):
    ...
    site_eng_id = db.Column(db.String(6), db.ForeignKey("SiteEngineerDetails.site_eng_id"), nullable = False, unique = False) # ID of the supervisor being used as foreign key
